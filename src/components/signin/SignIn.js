...
class SignIn extends Component {
    ...
    onFormSubmit = () => {
        fetch('https://frozen-shore-02309.herokuapp.com/signin', {
            method: 'post',
            ...
            <div className='center'>
                <article className="ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw5 bg-white shadow-5 br4">
                    ...
                    <div className="measure">
                        ...
                        className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Sign in" id="submit" />
                        </div>
